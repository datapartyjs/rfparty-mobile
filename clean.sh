...
cordova build android --debug --dev
ls -lah platforms/android/app/build/outputs/apk/debug/app-debug.apk && cp /home/alanm/rfparty-mobile/platforms/android/app/build/outputs/apk/debug/app-debug.apk rfparty-mobile.apk 
